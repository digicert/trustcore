 ...
 * win32oid.c
 *
 * OID Definitions for windows. This file can be included for windows build.
 *
...
MOC_EXTERN_DATA_DEF const ubyte cct_pkiData_oid[] =
{8, 0x2B, 0x06, 0x01, 0x05, 0x05, 0x07, 0x0C, 0x02}; /* 1.3.6.1.5.5.7.12.2 */
MOC_EXTERN_DATA_DEF const ubyte cct_PKIResponse_OID[] =
{ 8, 0x2B, 0x06, 0x01, 0x05, 0x05, 0x07, 0x0C, 0x03 }; /* 1.3.6.1.5.5.7.12.3 */
MOC_EXTERN_DATA_DEF const ubyte statusInfoV2_oid[] =
{ 8, 0x2B, 0x06, 0x01, 0x05, 0x05, 0x07, 0x07, 0x19 }; /* 1.3.6.1.5.5.7.7.25 */
MOC_EXTERN_DATA_DEF const ubyte batchRequests_oid[]  =
{0x08, 0x2B, 0x06, 0x01, 0x05, 0x05, 0x07, 0x07, 0x1C}; /* 1.3.6.1.5.5.7.7.28 */
MOC_EXTERN_DATA_DEF const ubyte batchResponses_oid[] =
