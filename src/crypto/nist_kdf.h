 ...
 * nist_kdf.h
 *
 * Implementation of the KDFs described in NIST 800-108
 *
 ...
 * @file       nist_kdf.h
 *
 * @brief      Header file for the NanoCrypto NIST-KDF APIs.
 *
 * @details    This file contains the NanoCrypto NIST-KDF API methods.
 *
 * @filedoc    nist_kdf.h
 */
...
#ifndef __NIST_KDF_HEADER__
#define __NIST_KDF_HEADER__
 ...
 * @funcdoc nist_kdf.h
 */
MOC_EXTERN MSTATUS KDF_NIST_CounterMode( MOC_SYM(hwAccelDescr hwAccelCtx)
 ...
 * @funcdoc nist_kdf.h
 */
MOC_EXTERN MSTATUS KDF_NIST_FeedbackMode( MOC_SYM(hwAccelDescr hwAccelCtx)
                                         ubyte4 counterSize, void* prfContext,
                                         const PRF_NIST_108* prfAlgo,
 ...
 * @funcdoc nist_kdf.h
 */
MOC_EXTERN MSTATUS KDF_NIST_DoublePipelineMode( MOC_SYM(hwAccelDescr hwAccelCtx)
                                         ubyte4 counterSize, void* prfContext,
                                         const PRF_NIST_108* prfAlgo,
                                         const ubyte* label, ubyte4 labelSize,
                                         const ubyte* context, ubyte4 contextSize,
