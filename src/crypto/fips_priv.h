...
enum FIPSAlgoTestNames
{
    ...
    FIPS_AES_GCM_256B_TESTNUM = 42,
    FIPS_AES_GCM_4K_TESTNUM = 43,
    FIPS_AES_GCM_64K_TESTNUM = 44,
    FIPS_AES_XTS_TESTNUM = 45,

    FIPS_3DES_CBC_TESTNUM = 46,

    FIPS_DH_TESTNUM = 47,
    FIPS_ECDH_TESTNUM = 48,
    FIPS_EDDH_TESTNUM = 49,

    FIPS_RSA_SIGGEN_TESTNUM = 50,
    FIPS_RSA_SIGVER_TESTNUM = 51,
    FIPS_RSA_WRAPPER_TESTNUM = 52,
    FIPS_DSA_SIGGEN_TESTNUM = 53,
    FIPS_DSA_SIGVER_TESTNUM = 54,
    FIPS_ECDSA_SIGGEN_TESTNUM = 55,
    FIPS_ECDSA_SIGVER_TESTNUM = 56,
    FIPS_EDDSA2_SIGGEN_TESTNUM = 57,
    FIPS_EDDSA2_SIGVER_TESTNUM = 58,
    FIPS_EDDSA4_SIGGEN_TESTNUM = 59,
    FIPS_EDDSA4_SIGVER_TESTNUM = 60,
    FIPS_MLKEM_KEY_TESTNUM = 61,
    FIPS_MLKEM_ENCAP_TESTNUM = 62,
    FIPS_MLKEM_DECAP_TESTNUM = 63,
    FIPS_MLDSA_KEY_TESTNUM = 64,
    FIPS_MLDSA_SIGN_TESTNUM = 65,
    FIPS_MLDSA_VERIFY_TESTNUM = 66,
    FIPS_SLHDSA_SHA2_KEY_TESTNUM = 67,
    FIPS_SLHDSA_SHA2_SIGN_TESTNUM = 68,
    FIPS_SLHDSA_SHA2_VERIFY_TESTNUM = 69,
    FIPS_SLHDSA_SHAKE_KEY_TESTNUM = 70,
    FIPS_SLHDSA_SHAKE_SIGN_TESTNUM = 71,
    FIPS_SLHDSA_SHAKE_VERIFY_TESTNUM = 72,

    /* Failure Test Names */
    FIPS_BREAK_PUBLIC_KEY_TESTNUM = 73,
    FIPS_DSA_CONSISTANCY_TESTNUM = 74,
    FIPS_RSA_CONSISTANCY_TESTNUM = 75,
    FIPS_ECDSA_CONSISTANCY_TESTNUM = 76,
    FIPS_EDDSA_CONSISTANCY_TESTNUM = 77,
    FIPS_MLDSA_CONSISTANCY_TESTNUM = 78,
    FIPS_SLHDSA_CONSISTANCY_TESTNUM = 79,
    FIPS_MLKEM_CONSISTANCY_TESTNUM = 80,

    FIPS_FORCE_FAIL_DRBG_CTR_RNG_TESTNUM = 81,
    FIPS_FORCE_FAIL_NO_ENTROPY_ADDED_TESTNUM = 82,
    FIPS_FORCE_FAIL_ENTROPY_HEALTH_TESTNUM = 83,
    FIPS_FORCE_FAIL_ENTROPY_LIMIT_TESTNUM = 84,

    /* Integrity Test Names */
    FIPS_INTEGRITY_CHECK_TESTNUM = 85,
    FIPS_INTEGRITY_FAIL_AND_CHECK_TESTNUM = 86,

    FIPS_MAX_TEST_COUNT = 87
};
...
#define FIPS_FORCE_FAIL_AES_GCM_4K_ENC_TEST    (ALGO_POWERUP_ENC_TESTSHOULDFAIL(FIPS_AES_GCM_4K_TESTNUM))
#define FIPS_FORCE_FAIL_AES_GCM_4K_DEC_TEST    (ALGO_POWERUP_DEC_TESTSHOULDFAIL(FIPS_AES_GCM_4K_TESTNUM))
#define FIPS_FORCE_FAIL_AES_GCM_64K_ENC_TEST   (ALGO_POWERUP_ENC_TESTSHOULDFAIL(FIPS_AES_GCM_64K_TESTNUM))
#define FIPS_FORCE_FAIL_AES_GCM_64K_DEC_TEST   (ALGO_POWERUP_DEC_TESTSHOULDFAIL(FIPS_AES_GCM_64K_TESTNUM))
...
#define FIPS_FORCE_FAIL_RSA_SIGGEN_TEST        (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_RSA_SIGGEN_TESTNUM))
#define FIPS_FORCE_FAIL_RSA_SIGVER_TEST        (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_RSA_SIGVER_TESTNUM))
#define FIPS_FORCE_FAIL_RSA_WRAPPER_TEST       (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_RSA_WRAPPER_TESTNUM)) /* Not used */
#define FIPS_FORCE_FAIL_DSA_SIGGEN_TEST        (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_DSA_SIGGEN_TESTNUM))
#define FIPS_FORCE_FAIL_DSA_SIGVER_TEST        (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_DSA_SIGVER_TESTNUM))
#define FIPS_FORCE_FAIL_ECDSA_SIGGEN_TEST      (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_ECDSA_SIGGEN_TESTNUM))
#define FIPS_FORCE_FAIL_ECDSA_SIGVER_TEST      (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_ECDSA_SIGVER_TESTNUM))
#define FIPS_FORCE_FAIL_EDDSA2_SIGGEN_TEST     (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_EDDSA2_SIGGEN_TESTNUM))
#define FIPS_FORCE_FAIL_EDDSA2_SIGVER_TEST     (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_EDDSA2_SIGVER_TESTNUM))
#define FIPS_FORCE_FAIL_EDDSA4_SIGGEN_TEST     (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_EDDSA4_SIGGEN_TESTNUM))
#define FIPS_FORCE_FAIL_EDDSA4_SIGVER_TEST     (ALGO_POWERUP_TESTSHOULDFAIL(FIPS_EDDSA4_SIGVER_TESTNUM))
