...
#ifndef __FREESCALE_8272_HEADER__
#define __FREESCALE_8272_HEADER__


/*------------------------------------------------------------------*/

/* Internal Memory Map Registers Base Address Register (IMMRBAR) */
#ifndef IMMRBAR_ADDRESS
#define IMMRBAR_ADDRESS                 0xf0000000
#endif
...
#define OFFSET_FETCH_ADRS               0x2048
#define OFFSET_DESCR_BUFS               0x2080
...
/* SEC, 4 Channels */
#define OFFSET_CHANNEL_1                (0x00001000)
#define OFFSET_CHANNEL_2                (0x00002000)
#define OFFSET_CHANNEL_3                (0x00003000)
#define OFFSET_CHANNEL_4                (0x00004000)
...
#define VALUE_ID_VERSION                FSL_VALUE(0,8)
/*
 * ID (VERSION) VALUE
 *
...
/* SEC, 4 Channels */
#define OFFSET_CHANNEL_CCPSR_1          (0x00001010)
...
/* SEC, 4 Channels */
#define OFFSET_CHANNEL_CCPSR_2          (0x00001014)
...
#define IMR_CHA_ERR_CH1                 FSL_BIT(2)
#define IMR_CHA_ERR_CH2                 FSL_BIT(0)
#define IMR_CHA_ERR_CH3                 FSL_BIT(14)
#define IMR_CHA_ERR_CH4                 FSL_BIT(12)
/*
 * IMR (CHA_ERR) BIT
 *
 * The channel has an Error bit.
...
#define IMR_CHA_DN_CH1                  FSL_BIT(3)
#define IMR_CHA_DN_CH2                  FSL_BIT(1)
#define IMR_CHA_DN_CH3                  FSL_BIT(15)
#define IMR_CHA_DN_CH4                  FSL_BIT(13)
/*
 * IMR (CHA_DN) BIT
 *
 * The channel has a Done bit.
...
#define ISR_CHA_ERR_CH1                 FSL_BIT(2)
#define ISR_CHA_ERR_CH2                 FSL_BIT(0)
#define ISR_CHA_ERR_CH3                 FSL_BIT(14)
#define ISR_CHA_ERR_CH4                 FSL_BIT(12)
/*
 * ISR (CHA_ERR) BIT
 *
 * The channel has an Error bit.
...
#define ISR_CHA_DN_CH1                  FSL_BIT(3)
#define ISR_CHA_DN_CH2                  FSL_BIT(1)
#define ISR_CHA_DN_CH3                  FSL_BIT(15)
#define ISR_CHA_DN_CH4                  FSL_BIT(13)
/*
 * IMR (CHA_DN) BIT
 *
 * The channel has a Done bit.
...
#define DEURCR                          0x00a018
#define AESURCR                         0x012018
#define MDEURCR                         0x00c018
#define AFEURCR                         0x008018
#define RNGRCR                          0x00e018
#define PKEURCR                         0x010018

#define DEUICR                          0x00a038
#define AESUICR                         0x012038
#define MDEUICR                         0x00c038
#define AFEUICR                         0x008038
#define RNGICR                          0x00e038
#define PKEUICR                         0x010038
...
#define DPD_HDR_DESC_SNOOP_NOHMAC_NOAF          0x1
...
#endif /* __FREESCALE_8272_HEADER__ */
