 ...
 * qstapcreate.c
 *
 * Create and initialize TAP QS keys.
 *
...
{
  MSTATUS status;
  MQsTapCreateArgs *pCreateArgs = NULL;
  MQsTapKeyData *pNewData;
  MQsTapKeyData *pData;
  ...
  if (NULL != pCreateInfo)
  {
    pCreateArgs = (MQsTapCreateArgs *)pCreateInfo;
  ...
  pMocAsymKey->KeyOperator = KeyOperatorQsTap;
  pMocAsymKey->localType = MOC_LOCAL_KEY_QS_PRI_TAP;
