/**
 * @file  ike2_eap_mschapv2_peer.c
 * @brief IKEv2 IKEv2 EAP-MSCHAPv2 Peer
 *
                                    ...
                                    ubyte *opaque_data)
{
    ...
    switch (type)
    {
        ...
        case EAP_TYPE_MSCHAPV2 :
        {
            ...
            ubyte4 identityStringLen = identityString ? DIGI_STRLEN(identityString) : 0;
            if (!cb->chapState)
            {
            ...
            else
            {
                status = EAP_MSCHAPpeerResponse(appSessionHdl,
                            ...
                            cb->peerChallenge,
                            cb->authChallenge,
                            (ubyte *)identityString, (ubyte2)identityStringLen,
