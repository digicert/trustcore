...
extern MSTATUS
AIX_mutexCreate(RTOS_MUTEX* pMutex, enum mutexTypes mutexType, int mutexCount)
{
...
extern MSTATUS
AIX_mutexWait(RTOS_MUTEX mutex)
{
...
extern MSTATUS
AIX_mutexRelease(RTOS_MUTEX mutex)
{
    pthread_mutex_t* pPthreadMutex = (pthread_mutex_t *)mutex;
...
extern MSTATUS
AIX_mutexFree(RTOS_MUTEX* pMutex)
{
    pthread_mutex_t* pPthreadMutex;
...
extern ubyte4
AIX_deltaMS(const moctime_t* origin, moctime_t* current)
{
    struct timeval tval;
    ubyte4 retVal = 0;
...
extern ubyte4
AIX_deltaConstMS(const moctime_t* origin, const moctime_t* current)
{
    struct timeval diff;
...
extern moctime_t *
AIX_timerAddMS(moctime_t* pTimer, ubyte4 addNumMS)
{
    ubyte4 sec;
...
extern void
AIX_sleepMS(ubyte4 sleepTimeInMS)
{
...
extern MSTATUS
AIX_createThread(void (*threadEntry)(void*), void* context, ubyte4 threadType, RTOS_THREAD *pRetTid)
{
    pthread_t   tid;
    int         ret;
    MSTATUS     status  = OK;
    ...
    {
        DEBUG_ERROR(DEBUG_PLATFORM, "AIX_createThread: pthread_create error ", ret);
...
extern void
AIX_destroyThread(RTOS_THREAD tid)
{
