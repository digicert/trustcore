...
extern MSTATUS
AIX_TCP_listenSocket(TCP_SOCKET *listenSocket, ubyte2 portNumber)
{
    ...
    if (0 > newSocket)
    {
        DEBUG_PRINTNL(DEBUG_PLATFORM, "AIX_TCP_listenSocket: Could not create listen socket");
    ...
    {
        DEBUG_PRINTNL(DEBUG_PLATFORM, "AIX_TCP_listenSocket: setsockopt(SO_REUSEADDR) error");
    ...
    {
        DEBUG_ERROR(DEBUG_PLATFORM, "AIX_TCP_listenSocket: bind() error : ", nRet);
        DEBUG_ERROR(DEBUG_PLATFORM, "AIX_TCP_listenSocket: bind() socket : ", newSocket);
    ...
    {
        DEBUG_ERROR(DEBUG_PLATFORM, "AIX_TCP_listenSocket: listen() error: ", nRet);
...
extern MSTATUS
AIX_TCP_acceptSocket(TCP_SOCKET *clientSocket, TCP_SOCKET listenSocket, intBoolean *isBreakSignalRequest)
{
...
} /* AIX_TCP_acceptSocket */


/*------------------------------------------------------------------*/

extern MSTATUS
AIX_TCP_connectSocket(TCP_SOCKET *pConnectSocket, sbyte *pIpAddress, ubyte2 portNo)
{
...
extern MSTATUS
AIX_TCP_closeSocket(TCP_SOCKET socket)
{
    close(socket);
    return OK;
}
...
extern MSTATUS
AIX_TCP_readSocketAvailable(TCP_SOCKET socket, sbyte *pBuffer,
...
} /* AIX_TCP_readSocketAvailable */


/*------------------------------------------------------------------*/

extern MSTATUS
AIX_TCP_writeSocket(TCP_SOCKET socket, sbyte *pBuffer, ubyte4 numBytesToWrite,
...
extern MSTATUS
AIX_TCP_getPeerName(TCP_SOCKET socket, ubyte2 *pRetPortNo, MOC_IP_ADDRESS_S *pRetAddr)
{
