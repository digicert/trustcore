...
extern MSTATUS
IRIX_mutexCreate(RTOS_MUTEX* pMutex, enum mutexTypes mutexType, int mutexCount)
{
...
extern MSTATUS
IRIX_mutexWait(RTOS_MUTEX mutex)
{
...
extern MSTATUS
IRIX_mutexRelease(RTOS_MUTEX mutex)
{
    pthread_mutex_t* pPthreadMutex = (pthread_mutex_t *)mutex;
...
extern MSTATUS
IRIX_mutexFree(RTOS_MUTEX* pMutex)
{
    pthread_mutex_t* pPthreadMutex;
...
extern ubyte4
IRIX_deltaMS(const moctime_t* origin, moctime_t* current)
{
    struct timeval tval;
    ubyte4 retVal = 0;
...
extern ubyte4
IRIX_deltaConstMS(const moctime_t* origin, const moctime_t* current)
{
    struct timeval diff;
...
extern moctime_t *
IRIX_timerAddMS(moctime_t* pTimer, ubyte4 addNumMS)
{
    ubyte4 sec;
...
extern void
IRIX_sleepMS(ubyte4 sleepTimeInMS)
{
...
extern MSTATUS
IRIX_createThread(void (*threadEntry)(void*), void* context, ubyte4 threadType, RTOS_THREAD* pRetTid)
{
    int         i;
    pthread_t   tid;
    int         ret;
    ...
    {
        DEBUG_ERROR(DEBUG_PLATFORM, "IRIX_createThread: pthread_create error ", ret);
...
extern void
IRIX_destroyThread(RTOS_THREAD tid)
{
