...
extern MSTATUS
CYGWIN_mutexCreate(RTOS_MUTEX* pMutex, enum mutexTypes mutexType, int mutexCount)
{
...
extern MSTATUS
CYGWIN_mutexWait(RTOS_MUTEX mutex)
{
...
extern MSTATUS
CYGWIN_mutexRelease(RTOS_MUTEX mutex)
{
    pthread_mutex_t* pPthreadMutex = (pthread_mutex_t *)mutex;
...
extern MSTATUS
CYGWIN_mutexFree(RTOS_MUTEX* pMutex)
{
    pthread_mutex_t* pPthreadMutex;
...
extern ubyte4
CYGWIN_deltaMS(const moctime_t* origin, moctime_t* current)
{
    struct timeval tval;
    ubyte4 retVal = 0;
...
extern ubyte4
CYGWIN_deltaConstMS(const moctime_t* origin, const moctime_t* current)
{
    struct timeval diff;
...
extern moctime_t *
CYGWIN_timerAddMS(moctime_t* pTimer, ubyte4 addNumMS)
{
    ubyte4 sec;
...
extern void
CYGWIN_sleepMS(ubyte4 sleepTimeInMS)
{
...
extern MSTATUS
CYGWIN_createThread(void (*threadEntry)(void*), void* context, ubyte4 threadType, RTOS_THREAD *pRetTid)
{
    pthread_t   tid;
    int         ret;
    MSTATUS     status  = OK;
...
extern void
CYGWIN_destroyThread(RTOS_THREAD tid)
{
...
extern MSTATUS
CYGWIN_condCreate(RTOS_COND* pCond, enum mutexTypes mutexType, int mutexCount)
{
...
extern MSTATUS
CYGWIN_condWait(RTOS_COND cond, RTOS_MUTEX mutex)
{
    pthread_mutex_t* pPthreadMutex = (pthread_mutex_t *)mutex;
...
extern MSTATUS
CYGWIN_condSignal(RTOS_COND cond)
{
    pthread_cond_t* pPthreadCond = (pthread_cond_t *)cond;
    MSTATUS          status  = ERR_RTOS_MUTEX_RELEASE;
...
extern MSTATUS
CYGWIN_condFree(RTOS_COND* pCond)
{
    pthread_cond_t* pPthreadCond;
    MSTATUS          status = ERR_RTOS_MUTEX_FREE;
