...
static void * digiprov_##alg##kbits##lc##_dupctx(void *provctx)                \
{                                                                              \
    return digiprov_##alg##_##lc##_dupctx(provctx);             \
}                                                                              \
const OSSL_DISPATCH digiprov_##alg##kbits##lc##_functions[] = {                \
    ...
    { OSSL_FUNC_CIPHER_DUPCTX, (void (*)(void))digiprov_##alg##kbits##lc##_dupctx },\
