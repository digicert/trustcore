...
static void *digiprov_aes_ccm_dupctx(void *vctx)
{
    MSTATUS status = OK;
    DP_CCM_CTX *ctx = (DP_CCM_CTX *)vctx;
    DP_CCM_CTX *dupctx = NULL;
    ...
    *dupctx = *ctx;
    ...
    if (!digiprov_ccm_set_mode(dupctx->pEvpCtx, dupctx->keylen * 8, 96))
    {
        digiprov_aes_ccm_freectx(dupctx);
        return NULL;
    }
