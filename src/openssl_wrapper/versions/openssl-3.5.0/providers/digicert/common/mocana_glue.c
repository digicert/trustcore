...
static const BulkHashAlgo BLAKE2BSuite =
#ifdef __ENABLE_DIGICERT_CRYPTO_INTERFACE__
    { MOC_BLAKE2B_MAX_OUTLEN, MOC_BLAKE2B_BLOCKLEN,
      CRYPTO_INTERFACE_BLAKE_2B_alloc,
      CRYPTO_INTERFACE_BLAKE_2B_delete,
      (BulkCtxInitFunc)BLAKE2B_initEx,
      (BulkCtxUpdateFunc)CRYPTO_INTERFACE_BLAKE_2B_update,
...
static const BulkHashAlgo BLAKE2SSuite =
#ifdef __ENABLE_DIGICERT_CRYPTO_INTERFACE__
    { MOC_BLAKE2S_MAX_OUTLEN, MOC_BLAKE2S_BLOCKLEN,
      CRYPTO_INTERFACE_BLAKE_2S_alloc,
      CRYPTO_INTERFACE_BLAKE_2S_delete,
      (BulkCtxInitFunc)BLAKE2S_initEx,
      (BulkCtxUpdateFunc)CRYPTO_INTERFACE_BLAKE_2S_update,
...
#ifdef __ENABLE_DIGICERT_BLAKE_2B__
static const MOC_EVP_MD EVP_BLAKE2BSuite = { &BLAKE2BSuite, MOC_BLAKE2B_MAX_OUTLEN, NID_blake2b512 };
#endif
#ifdef __ENABLE_DIGICERT_BLAKE_2S__
static const MOC_EVP_MD EVP_BLAKE2SSuite = { &BLAKE2SSuite, MOC_BLAKE2S_MAX_OUTLEN, NID_blake2s256 };
#endif

#if defined(__ENABLE_DIGICERT_SHA3__) && (defined(__ENABLE_DIGICERT_OPENSSL_LIB_3_0__) || defined(__ENABLE_DIGICERT_OPENSSL_LIB_3_5__))
...
#ifdef __ENABLE_DIGICERT_BLAKE_2B__
        case NID_blake2b512:
            ctx->pDigestAlgo = &EVP_BLAKE2BSuite;
            break;
#endif
#ifdef __ENABLE_DIGICERT_BLAKE_2S__
        case NID_blake2s256:
            ctx->pDigestAlgo = &EVP_BLAKE2SSuite;
            break;
#endif
        default:
            break;
...
#endif /* #if (defined(__ENABLE_DIGICERT_OPENSSL_LIB_3_0__) || defined(__ENABLE_DIGICERT_OPENSSL_LIB_3_5__)) && !defined(__DISABLE_3DES_TWO_KEY_CIPHER__) */
...
static const BulkEncryptionAlgo CRYPTO_ChaChaSuite = { 64, (CreateBulkCtxFunc) CRYPTO_INTERFACE_CreateChaCha20Ctx,
                                                           ...
                                                           CRYPTO_INTERFACE_CloneChaCha20Ctx };
#else
