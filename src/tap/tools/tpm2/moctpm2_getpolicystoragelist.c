/**
 @file moctpm2_getpolicystoragelist.c

 @page digicert_tpm2_getpolicystoragelist
 ...
 # SYNOPSIS
 `digicert_tpm2_getpolicystoragelist [options]`

 # DESCRIPTION
 <B>digicert_tpm2_getpolicystoragelist</B> This tool displays list of configured NVRAM and Persistent entity IDs.
...
void printHelp()
{
    LOG_MESSAGE("digicert_tpm2_getpolicystoragelist: Help Menu\n");
    LOG_MESSAGE("This tool lists the indices of NVRAM and persistent objects\n");
...
#endif
            {"modulenum", required_argument, NULL, 5},
            {NULL, 0, NULL, 0},
    };
#ifndef __ENABLE_TAP_REMOTE__
    ubyte4  optValLen = 0;
...
exit:
    ...
    if (0 != retval)
        LOG_ERROR("*****digicert_tpm2_getpolicystoragelist failed to complete successfully.*****");
