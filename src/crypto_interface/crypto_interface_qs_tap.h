...
#ifndef __CRYPTO_INTERFACE_QS_TAP_HEADER__
#define __CRYPTO_INTERFACE_QS_TAP_HEADER__
...
/**
 * @brief   Sets an QS context to not unload the internal TAP Key upon cipher completion. 
 * @details Sets an QS context to not unload the internal TAP Key upon cipher completion. 
 *
 * @param pCtx                Pointer to a TAP enabled QS context containing a TAP Key.
...
#endif /* __CRYPTO_INTERFACE_QS_TAP_HEADER__ */
