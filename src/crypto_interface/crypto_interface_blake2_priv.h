...
#if ( defined(__ENABLE_DIGICERT_CRYPTO_INTERFACE_BLAKE_2B_MAPPING__)) && \
    (!defined(__ENABLE_DIGICERT_CRYPTO_INTERFACE_BLAKE_2B_INTERNAL__))
...
#if ( defined(__ENABLE_DIGICERT_CRYPTO_INTERFACE_BLAKE_2S_MAPPING__)) && \
    (!defined(__ENABLE_DIGICERT_CRYPTO_INTERFACE_BLAKE_2S_INTERNAL__))
