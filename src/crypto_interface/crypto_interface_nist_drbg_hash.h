/*
 * crypto_interface_nist_drbg_hash.h
 *
 * Cryptographic Interface header file for declaring NIST DRBG HASH functions
...
/**
@file       crypto_interface_nist_drbg_hash.h
@brief      Cryptographic Interface header file for declaring NIST DRBG HASH functions.
@details    Add details here.

@filedoc    crypto_interface_nist_drbg_hash.h
*/
#ifndef __CRYPTO_INTERFACE_NIST_DRBG_HASH_HEADER__
#define __CRYPTO_INTERFACE_NIST_DRBG_HASH_HEADER__
 ...
 *          to call \c CRYPTO_INTERFACE_NIST_HASHDRBG_deleteContext to free this context when
 *          done with it.
 *
 ...
 *
 * @funcdoc crypto_interface_nist_drbg_hash.h
 */
 ...
 *          For generating bits from additional input use \c CRYPTO_INTERFACE_NIST_HASHDRBG_generate
 *          instead.
 *
 * @param pContext            Pointer to a previously seeded context.
 * @param pOutput             Buffer to hold the resulting output bytes.
...
#endif /* __CRYPTO_INTERFACE_NIST_DRBG_HASH_HEADER__ */
