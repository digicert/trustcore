...
/**
 ...
 @brief      Cryptographic Interface header file for declaring HMAC-KDF functions.
 
 @filedoc    crypto_interface_hmac_kdf.h
 */
#ifndef __CRYPTO_INTERFACE_HMAC_KDF_HEADER__
#define __CRYPTO_INTERFACE_HMAC_KDF_HEADER__
...
#endif /* __CRYPTO_INTERFACE_HMAC_KDF_HEADER__ */
