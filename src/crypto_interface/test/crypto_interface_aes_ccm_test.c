/*
 * crypto_interface_aes_ccm_test.c
 *
 * unit test for AES-CCM
 *
...
int crypto_interface_aes_ccm_test_init()
{
    MSTATUS status;
    int i, retVal = 0;
    hwAccelDescr hwAccelCtx;
    ...
    retVal += aes_ccm_test_vectors();
    retVal += aes_ccm_test_create_delete_cipher();
#endif /* __ENABLE_DIGICERT_CRYPTO_INTERFACE_EXPORT__ */
