 ...
 */
/**
@file       crypto_interface_ecc_eg.h
@brief      Cryptographic Interface header file for declaring ECEG functions.
@details    Add details here.

@filedoc    crypto_interface_ecc_eg.h
*/

/*------------------------------------------------------------------*/

#ifndef __CRYPTO_INTERFACE_PRIMEEC_EG_HEADER__
#define __CRYPTO_INTERFACE_PRIMEEC_EG_HEADER__
 ...
 *           of input data has been surpassed in total. Please see the \c CRYPTO_INTERFACE_ECEG_encrypt and
 *           \c CRYPTO_INTERFACE_ECEG_decrypt descriptions for more about input and output block lengths.
 *
 ...
 *           \c CRYPTO_INTERFACE_ECEG_encrypt and \c CRYPTO_INTERFACE_ECEG_decrypt descriptions for more about
 ...
 * @param pExtCtx       An extended context reserved for future use.
 *
 * @warning             The \c CRYPTO_INTERFACE_ECEG_decryptPKCSv1p5 API assumes encryption used a 4 byte
...
#endif /* __CRYPTO_INTERFACE_PRIMEEC_EG_HEADER__ */
