/*
 * trustedge_scep_defn.h
 *
 * SCEP general definitions
 *
...
@filedoc    trustedge_scep_defn.h
*/

#ifndef __TRUSTEDGE_SCEP_DEFN_HEADER__
#define __TRUSTEDGE_SCEP_DEFN_HEADER__
...
/* the following messageType codes are not defined by SCEP RFC */
...
/* the following failInfo codes are not defined by SCEP RFC */
scep_unknownError=5
} SCEP_failInfo;
...
@callbackdoc    trustedge_scep_defn.h
*/
...
@details    Revokation %reason: any of the \c certRevokeReasonFlags
            enumerated values (see trustedge_scep_defn.h).
*/
...
@details    SCEP message %type: any of the \c SCEP_messageType enumerated
            values (defined in trustedge_scep_defn.h).
*/
...
#endif  /*#ifndef __TRUSTEDGE_SCEP_DEFN_HEADER__ */
