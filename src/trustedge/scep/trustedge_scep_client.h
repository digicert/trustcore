/*
 * trustedge_scep_client.h
 *
 * SCEP client operation routines
 *
...
@filedoc    trustedge_scep_client.h
*/
#ifndef __TRUSTEDGE_SCEP_CLIENT_HEADER__
#define __TRUSTEDGE_SCEP_CLIENT_HEADER__
...
@ingroup    func_trustedge_scep_client_http
...
@inc_file   trustedge_scep_client.h
...
@funcdoc    trustedge_scep_client.h
*/
MOC_EXTERN sbyte4
...
@ingroup    func_trustedge_scep_client_comm
...
@param ppRequestInfo    Pointer to \c requestInfo structure containing desired parameters.
...
@note       This function only builds the request. To send the request, you
            ...
            function. For details, refer to trustedge_scep_client_example.c in the examples directory.
...
@note       This function only builds the request. To send the request, you
            must use this function's results as input to an \c HTTP_REQUEST_*
            function. For details, refer to trustedge_scep_client_example.c in the
            examples directory.
...
@note       This function only builds the polling request. To begin polling,
            ...
            trustedge_scep_client_example.c in the examples directory.
...
#endif  /*#ifndef __TRUSTEDGE_SCEP_CLIENT_HEADER__ */
