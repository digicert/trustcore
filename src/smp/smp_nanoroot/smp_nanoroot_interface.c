...
)
{
    ...
    case SMP_CC_GET_MODULE_LIST                          :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getModuleList,
    ...
    case SMP_CC_FREE_MODULE_LIST                         :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, freeModuleList,
    ...
    case SMP_CC_GET_MODULE_INFO                  :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getModuleInfo,
    ...
    case SMP_CC_GET_MODULE_SLOTS                         :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getModuleSlots,
    ...
    case SMP_CC_GET_TOKEN_LIST                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getTokenList,
    ...
    case SMP_CC_GET_TOKEN_INFO                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getTokenInfo,
    ...
    case SMP_CC_GET_OBJECT_LIST                          :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getObjectList,
    ...
    case SMP_CC_GET_OBJECT_INFO                          :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getObjectInfo,
    ...
    case SMP_CC_PROVISION_MODULE                         :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, provisionModule,
    ...
    case SMP_CC_RESET_MODULE                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, resetModule,
    ...
    case SMP_CC_PROVISION_TOKEN                          :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, provisionTokens,
    ...
    case SMP_CC_RESET_TOKEN                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, resetToken,
    ...
    case SMP_CC_DELETE_TOKEN                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, deleteToken,
    ...
    case SMP_CC_INIT_MODULE                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, initModule,
    ...
    case SMP_CC_UNINIT_MODULE                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, uninitModule,
    ...
    case SMP_CC_ASSOCIATE_MODULE_CREDENTIALS             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, associateModuleCredentials,
    ...
    case SMP_CC_INIT_TOKEN                               :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, initToken,
    ...
    case SMP_CC_UNINIT_TOKEN                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, uninitToken,
    ...
    case SMP_CC_ASSOCIATE_TOKEN_CREDENTIALS              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, associateTokenCredentials,
    ...
    case SMP_CC_INIT_OBJECT                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, initObject,
    ...
    case SMP_CC_IMPORT_OBJECT                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, importObject,
    ...
    case SMP_CC_UNINIT_OBJECT                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, uninitObject,
    ...
    case SMP_CC_ASSOCIATE_OBJECT_CREDENTIALS             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, associateObjectCredentials,
    ...
    case SMP_CC_VERIFY                                   :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, verify,
    ...
    case SMP_CC_VERIFY_INIT                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, verifyInit,
    ...
    case SMP_CC_VERIFY_UPDATE                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, verifyUpdate,
    ...
    case SMP_CC_VERIFY_FINAL                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, verifyFinal,
    ...
    case SMP_CC_SIGN_DIGEST                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, signDigest,
    ...
    case SMP_CC_SIGN_BUFFER                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, signBuffer,
    ...
    case SMP_CC_SIGN_INIT                                :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, signInit,
    ...
    case SMP_CC_SIGN_UPDATE                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, signUpdate,
    ...
    case SMP_CC_SIGN_FINAL                               :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, signFinal,
    ...
    case SMP_CC_FREE_SIGNATURE_BUFFER                    :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, freeSignatureBuffer,
    ...
    case SMP_CC_ENCRYPT                                  :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, encrypt,
    ...
    case SMP_CC_ENCRYPT_INIT                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, encryptInit,
    ...
    case SMP_CC_ENCRYPT_UPDATE                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, encryptUpdate,
    ...
    case SMP_CC_ENCRYPT_FINAL                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, encryptFinal,
    ...
    case SMP_CC_DECRYPT                                  :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, decrypt,
    ...
    case SMP_CC_DECRYPT_INIT                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, decryptInit,
    ...
    case SMP_CC_DECRYPT_UPDATE                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, decryptUpdate,
    ...
    case SMP_CC_DECRYPT_FINAL                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, decryptFinal,
    ...
    case SMP_CC_DIGEST                                   :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, digest,
    ...
    case SMP_CC_DIGEST_INIT                              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, digestInit,
    ...
    case SMP_CC_DIGEST_UPDATE                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, digestUpdate,
    ...
    case SMP_CC_DIGEST_FINAL                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, digestFinal,
    ...
    case SMP_CC_GET_TRUSTED_DATA                         :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getTrustedData,
    ...
    case SMP_CC_UPDATE_TRUSTED_DATA                      :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, updateTrustedData,
    ...
    case SMP_CC_SEAL_WITH_TRUSTED_DATA                   :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, sealWithTrustedData,
    ...
    case SMP_CC_UNSEAL_WITH_TRUSTED_DATA                 :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, unsealWithTrustedData,
    ...
    case SMP_CC_SET_POLICY_STORAGE                       :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, setPolicyStorage,
    ...
    case SMP_CC_GET_POLICY_STORAGE                       :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getPolicyStorage,
    ...
    case SMP_CC_GET_CERTIFICATE_REQUEST_VALIDATION_ATTRS :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getCertificateRequestValidationAttrs,
    ...
    case SMP_CC_UNWRAP_KEY_VALIDATED_SECRET              :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, unWrapKeyValidatedSecret,
    ...
    case SMP_CC_SMP_GET_QUOTE                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getQuote,
    ...
    case SMP_CC_CREATE_ASYMMETRIC_KEY                    :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, createAsymmetricKey,
    ...
    case SMP_CC_GET_PRIVATE_KEY_BLOB                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getPrivateKeyBlob,
    ...
    case SMP_CC_GET_PUBLIC_KEY                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getPublicKey,
    ...
    case SMP_CC_GET_PUBLIC_KEY_BLOB                           :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getPublicKeyBlob,
    ...
    case SMP_CC_DUPLICATEKEY:
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, duplicateKey,
    ...
    case SMP_CC_IMPORTDUPLICATEKEY:
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, importDuplicateKey,
    ...
    case SMP_CC_FREE_PUBLIC_KEY                          :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, freePublicKey,
    ...
    case SMP_CC_CREATE_SYMMETRIC_KEY                     :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, createSymmetricKey,
    ...
    case SMP_CC_EXPORT_OBJECT                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, exportObject,
    ...
    case SMP_CC_SERIALIZE_OBJECT                         :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, serializeObject,
    ...
    case SMP_CC_CREATE_OBJECT                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, createObject,
    ...
    case SMP_CC_DELETE_OBJECT                            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, deleteObject,
    ...
    case SMP_CC_PURGE_OBJECT                             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, purgeObject,
                pCmdReq->reqParams.deleteObject.moduleHandle,
                pCmdReq->reqParams.deleteObject.tokenHandle,
                pCmdReq->reqParams.deleteObject.objectHandle
        );
    ...
    case SMP_CC_GET_ROOT_OF_TRUST_CERTIFICATE            :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getRootOfTrustCertificate,
    ...
    case SMP_CC_GET_ROOT_OF_TRUST_KEY_HANDLE             :
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getRootOfTrustKeyHandle,
    ...
    case SMP_CC_GET_LAST_ERROR:
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, getLastError,
    ...
    case SMP_CC_SELF_TEST:
        pCmdRsp->returnCode = CALL_SMP_API(NanoROOT, selfTest,
