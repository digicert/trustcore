 ...
 *           communicate/manage PKCS11 NanoSMP module plugin.
 */
...
byteBoolean SMP_PKCS11_cmd_Supported(SMP_CC cmd)
{
...
)
{
    ...
    status = PKCS11_init(pConfigInfo);
    if (status)
    {
        goto exit;
    }
    ...
    {
        if (TRUE == SMP_PKCS11_cmd_Supported(cmd))
            supportedLen++;
    }
...
MSTATUS SMP_PKCS11_unregister()
{
    MSTATUS status;

    status = PKCS11_deInit();
    return status;
}

MSTATUS SMP_PKCS11_dispatcher(
...
)
{
    ...
    case SMP_CC_GET_MODULE_LIST                          :
        CALL_SMP_API(PKCS11, getModuleList,
    ...
    case SMP_CC_FREE_MODULE_LIST                         :
        CALL_SMP_API(PKCS11, freeModuleList,
    ...
    case SMP_CC_GET_MODULE_INFO                  :
        CALL_SMP_API(PKCS11, getModuleInfo,
    ...
    case SMP_CC_GET_MODULE_SLOTS                         :
        CALL_SMP_API(PKCS11, getModuleSlots,
    ...
    case SMP_CC_GET_TOKEN_LIST                           :
        CALL_SMP_API(PKCS11, getTokenList,
    ...
    case SMP_CC_GET_TOKEN_INFO                           :
        CALL_SMP_API(PKCS11, getTokenInfo,
    ...
    case SMP_CC_GET_OBJECT_LIST                          :
        CALL_SMP_API(PKCS11, getObjectList,
    ...
    case SMP_CC_GET_OBJECT_INFO                          :
        CALL_SMP_API(PKCS11, getObjectInfo,
    ...
    case SMP_CC_PROVISION_MODULE                         :
        CALL_SMP_API(PKCS11, provisionModule,
    ...
    case SMP_CC_RESET_MODULE                             :
        CALL_SMP_API(PKCS11, resetModule,
    ...
    case SMP_CC_PROVISION_TOKEN                          :
        CALL_SMP_API(PKCS11, provisionTokens,
    ...
    case SMP_CC_RESET_TOKEN                              :
        CALL_SMP_API(PKCS11, resetToken,
    ...
    case SMP_CC_DELETE_TOKEN                             :
        CALL_SMP_API(PKCS11, deleteToken,
    ...
    case SMP_CC_INIT_MODULE                              :
        CALL_SMP_API(PKCS11, initModule,
    ...
    case SMP_CC_UNINIT_MODULE                            :
        CALL_SMP_API(PKCS11, uninitModule,
    ...
    case SMP_CC_ASSOCIATE_MODULE_CREDENTIALS             :
        CALL_SMP_API(PKCS11, associateModuleCredentials,
    ...
    case SMP_CC_UNINIT_TOKEN                             :
        CALL_SMP_API(PKCS11, uninitToken,
    ...
    case SMP_CC_ASSOCIATE_TOKEN_CREDENTIALS              :
        CALL_SMP_API(PKCS11, associateTokenCredentials,
    ...
    case SMP_CC_INIT_OBJECT                              :
        CALL_SMP_API(PKCS11, initObject,
    ...
    case SMP_CC_IMPORT_OBJECT                              :
        CALL_SMP_API(PKCS11, importObject,
    ...
    case SMP_CC_UNINIT_OBJECT                            :
        CALL_SMP_API(PKCS11, uninitObject,
    ...
    case SMP_CC_EVICT_OBJECT                                :
        pCmdRsp->returnCode = CALL_SMP_API(PKCS11, evictObject,
    ...
    case SMP_CC_PERSIST_OBJECT:
        pCmdRsp->returnCode = CALL_SMP_API(PKCS11, persistObject,
    ...
    case SMP_CC_ASSOCIATE_OBJECT_CREDENTIALS             :
        CALL_SMP_API(PKCS11, associateObjectCredentials,
    ...
    case SMP_CC_VERIFY_INIT                              :
        CALL_SMP_API(PKCS11, verifyInit,
    ...
    case SMP_CC_VERIFY_UPDATE                            :
        CALL_SMP_API(PKCS11, verifyUpdate,
    ...
    case SMP_CC_VERIFY_FINAL                             :
        CALL_SMP_API(PKCS11, verifyFinal,
    ...
    case SMP_CC_SIGN_DIGEST                              :
        CALL_SMP_API(PKCS11, signDigest,
    ...
    case SMP_CC_SIGN_BUFFER                              :
        CALL_SMP_API(PKCS11, signBuffer,
    ...
    case SMP_CC_SIGN_UPDATE                              :
        CALL_SMP_API(PKCS11, signUpdate,
    ...
    case SMP_CC_FREE_SIGNATURE_BUFFER                    :
        CALL_SMP_API(PKCS11, freeSignatureBuffer,
    ...
    case SMP_CC_ENCRYPT_INIT                             :
        CALL_SMP_API(PKCS11, encryptInit,
    ...
    case SMP_CC_ENCRYPT_UPDATE                           :
        CALL_SMP_API(PKCS11, encryptUpdate,
    ...
    case SMP_CC_ENCRYPT_FINAL                            :
        CALL_SMP_API(PKCS11, encryptFinal,
    ...
    case SMP_CC_DECRYPT_INIT                             :
        CALL_SMP_API(PKCS11, decryptInit,
    ...
    case SMP_CC_DECRYPT_UPDATE                           :
        CALL_SMP_API(PKCS11, decryptUpdate,
    ...
    case SMP_CC_DECRYPT_FINAL                            :
        CALL_SMP_API(PKCS11, decryptFinal,
    ...
    case SMP_CC_DIGEST_INIT                              :
        CALL_SMP_API(PKCS11, digestInit,
    ...
    case SMP_CC_DIGEST_UPDATE                            :
        CALL_SMP_API(PKCS11, digestUpdate,
    ...
    case SMP_CC_DIGEST_FINAL                             :
        CALL_SMP_API(PKCS11, digestFinal,
    ...
    case SMP_CC_STIR_RANDOM                              :
        CALL_SMP_API(PKCS11, stirRandom,
    ...
    case SMP_CC_GET_TRUSTED_DATA                         :
        CALL_SMP_API(PKCS11, getTrustedData,
    ...
    case SMP_CC_UPDATE_TRUSTED_DATA                      :
        CALL_SMP_API(PKCS11, updateTrustedData,
    ...
    case SMP_CC_SEAL_WITH_TRUSTED_DATA                   :
        CALL_SMP_API(PKCS11, sealWithTrustedData,
    ...
    case SMP_CC_UNSEAL_WITH_TRUSTED_DATA                 :
        CALL_SMP_API(PKCS11, unsealWithTrustedData,
    ...
    case SMP_CC_SET_POLICY_STORAGE                       :
        CALL_SMP_API(PKCS11, setPolicyStorage,
    ...
    case SMP_CC_GET_POLICY_STORAGE                       :
        CALL_SMP_API(PKCS11, getPolicyStorage,
    ...
    case SMP_CC_GET_CERTIFICATE_REQUEST_VALIDATION_ATTRS :
        CALL_SMP_API(PKCS11, getCertificateRequestValidationAttrs,
    ...
    case SMP_CC_UNWRAP_KEY_VALIDATED_SECRET              :
        CALL_SMP_API(PKCS11, unWrapKeyValidatedSecret,
    ...
    case SMP_CC_CREATE_ASYMMETRIC_KEY                    :
        CALL_SMP_API(PKCS11, createAsymmetricKey,
    ...
    case SMP_CC_GET_PUBLIC_KEY                           :
        CALL_SMP_API(PKCS11, getPublicKey,
    ...
    case SMP_CC_FREE_PUBLIC_KEY                          :
        CALL_SMP_API(PKCS11, freePublicKey,
    ...
    case SMP_CC_CREATE_SYMMETRIC_KEY                     :
        CALL_SMP_API(PKCS11, createSymmetricKey,
    ...
    case SMP_CC_EXPORT_OBJECT                            :
        CALL_SMP_API(PKCS11, exportObject,
    ...
    case SMP_CC_SERIALIZE_OBJECT                         :
        CALL_SMP_API(PKCS11, serializeObject,
...
#endif
        CALL_SMP_API(PKCS11, createObject,
    ...
    case SMP_CC_DELETE_OBJECT                            :
        CALL_SMP_API(PKCS11, deleteObject,
    ...
    case SMP_CC_PURGE_OBJECT                             :
        CALL_SMP_API(PKCS11, purgeObject,
                pCmdReq->reqParams.deleteObject.moduleHandle,
                pCmdReq->reqParams.deleteObject.tokenHandle,
                pCmdReq->reqParams.deleteObject.objectHandle
        );
    ...
    case SMP_CC_GET_ROOT_OF_TRUST_CERTIFICATE            :
        CALL_SMP_API(PKCS11, getRootOfTrustCertificate,
    ...
    case SMP_CC_GET_ROOT_OF_TRUST_KEY_HANDLE             :
        CALL_SMP_API(PKCS11, getRootOfTrustKeyHandle,
    ...
    case SMP_CC_DUPLICATEKEY:
        CALL_SMP_API(PKCS11, duplicateKey,
    ...
    case SMP_CC_IMPORTDUPLICATEKEY:
        CALL_SMP_API(PKCS11, importDuplicateKey,
    ...
    case SMP_CC_GET_LAST_ERROR:
        CALL_SMP_API(PKCS11, getLastError,
