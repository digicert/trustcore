 ...
 *
 *@file      smp_PKCS11_interface.h
 *@brief     NanoSMP provider Interface that an application(NanoTAP) will use to
 *           communicate/manage PKCS11 SMP module plugin.
 *@details   This header file contains definitions, enumerations, and function
 *           declarations used by NanoTAP to communicate/manage PKCS11 NanoSMP
 *           module plugin.
 */

#ifndef __SMP_PKCS11_INTERFACE_HEADER__
#define __SMP_PKCS11_INTERFACE_HEADER__
...
#endif /* __SMP_PKCS11_INTERFACE_HEADER__ */
