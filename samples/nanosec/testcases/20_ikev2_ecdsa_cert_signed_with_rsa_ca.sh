# IKEv2 ECDSA Cert signed with RSA CA

TC_NAME="Testcase 20 IKEv2 ECDSA Cert signed with RSA CA / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    --ike_cert    keystore/openssl_ecdsa_cert_rsa_ca_crt.der
    --ike_keyblob keystore/openssl_ecdsa_cert_rsa_ca_key.pem
