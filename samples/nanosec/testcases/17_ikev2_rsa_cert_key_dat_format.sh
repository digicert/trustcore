# IKEv2 RSA Cert and key in dat format

TC_NAME="Testcase 17 IKEv2 RSA Cert and key in dat format / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    ...
    --ike_keyblob keystore/RSACertCAKey.dat
