...
TC_NAME="Testcase 15 IKEv2 Ed448 Cert / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    --ike_cert    keystore/openssl_ed448_crt.der
    --ike_keyblob keystore/openssl_ed448_key.pem
