# IKEv2 RSA Cert and PKCS1 key

TC_NAME="Testcase 21 IKEv2 RSA Cert and PKCS1 key / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    ...
    --ike_keyblob keystore/openssl_rsa_key.pem
