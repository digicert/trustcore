# IKEv2 ECDSA Cert and raw x9.62 key

TC_NAME="Testcase 23 IKEv2 ECDSA Cert and raw x9.62 key / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    ...
    --ike_keyblob keystore/openssl_ecdsa_key.pem
