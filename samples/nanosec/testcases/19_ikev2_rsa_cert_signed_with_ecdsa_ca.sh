# IKEv2 RSA Cert signed with ECDSA CA

TC_NAME="Testcase 19 IKEv2 RSA Cert signed with ECDSA CA / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    --ike_cert    keystore/openssl_rsa_cert_ecdsa_ca_crt.der
    --ike_keyblob keystore/openssl_rsa_cert_ecdsa_ca_key.pem
