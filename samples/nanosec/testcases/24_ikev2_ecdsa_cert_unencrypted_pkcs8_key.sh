# IKEv2 ECDSA Cert and unencrypted pkcs8 key

TC_NAME="Testcase 24 IKEv2 ECDSA Cert and unencrypted pkcs8 key / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2

TC_RESP_IKE_FLAGS=(
    --ike_cert    ipsec_keystore/nanosec_rsa_sha1_crt.der
    --ike_keyblob ipsec_keystore/nanosec_rsa_sha1_key.pem
    --ike_ca_cert keystore/openssl_ec_ca_crt.der
)
TC_INIT_IKE_FLAGS=(
    --ike_cert    keystore/openssl_ecdsa_crt.der
    --ike_keyblob keystore/openssl_ecdsa_nocrypt_pkcs8_key.pem
