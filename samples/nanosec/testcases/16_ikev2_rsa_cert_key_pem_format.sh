# IKEv2 RSA Cert and Key in pem format 

TC_NAME="Testcase 16 IKEv2 RSA Cert and key in pem format / NanoSec as Initiator and Responder"
TC_IKE_VERSION=2
...
TC_INIT_IKE_FLAGS=(
    ...
    --ike_keyblob keystore/RSACertCAKey.pem
