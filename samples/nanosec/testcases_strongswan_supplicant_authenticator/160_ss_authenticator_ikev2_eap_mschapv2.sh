# IKEv2 EAP-MSCHAPv2 — NanoSec initiates as EAP supplicant, StrongSwan responds
# as EAP authenticator (pubkey + eap-mschapv2)

TC_NAME="Testcase 160 IKEv2 EAP-MSCHAPv2 / NanoSec(supplicant)->StrongSwan(authenticator), esp:aes128-sha256-modp3072"
TC_IKE_VERSION=2
...
if [[ -z "$TC_SKIP_REASON" ]] && ! tc_gen_certs tc_160 rsa rsa; then
