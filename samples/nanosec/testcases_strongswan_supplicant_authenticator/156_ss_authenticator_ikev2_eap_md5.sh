# IKEv2 EAP-MD5 — NanoSec initiates as EAP supplicant, StrongSwan responds
# as EAP authenticator (pubkey + eap-md5)

TC_NAME="Testcase 156 IKEv2 EAP-MD5 / NanoSec(supplicant)->StrongSwan(authenticator), esp:aes128-sha256-modp3072"
TC_IKE_VERSION=2
...
if [[ -z "$TC_SKIP_REASON" ]] && ! tc_gen_certs tc_156 rsa rsa; then
