...
# aes192ccm96-prfsha1-ecp192

TC_NAME="Testcase 83 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192ccm96-prfsha1-ecp192 esp:aes128-sha1-ecp192"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192ccm96-prfsha1-ecp192
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha1-ecp192
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
