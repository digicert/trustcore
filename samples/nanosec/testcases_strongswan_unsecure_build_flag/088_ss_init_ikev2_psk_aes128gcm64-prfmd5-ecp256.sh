...
# aes128gcm64-prfmd5-ecp256

TC_NAME="Testcase 88 IKEv2 PSK / StrongSwan->NanoSec / ike:aes128gcm64-prfmd5-ecp256 esp:aes128-md5-ecp256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes128gcm64-prfmd5-ecp256
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-md5-ecp256
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
