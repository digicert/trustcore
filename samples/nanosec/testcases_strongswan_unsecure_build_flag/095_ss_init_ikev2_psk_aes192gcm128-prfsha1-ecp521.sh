...
# aes192gcm128-prfsha1-ecp521

TC_NAME="Testcase 95 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192gcm128-prfsha1-ecp521 esp:aes128-sha1-ecp521"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192gcm128-prfsha1-ecp521
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha1-ecp521
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha1 encr_algs aes keylength 16 }
EOF
}
