...
# blowfish128-sha256-modp3072

TC_NAME="Testcase 17 IKEv1 PSK / StrongSwan->NanoSec / ike:blowfish128-sha256-modp3072 esp:blowfish128-sha256-modp3072"
TC_IKE_VERSION=1
...
connections {
    nanosec-interop {
        ...
        proposals = blowfish128-sha256-modp3072
        children {
            child1 {
                mode          = transport
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha256 encr_algs blowfish keylength 16 }
EOF
}
