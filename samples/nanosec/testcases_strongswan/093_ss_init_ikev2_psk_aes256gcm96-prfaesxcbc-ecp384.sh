...
# aes256gcm96-prfaesxcbc-ecp384

TC_NAME="Testcase 93 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256gcm96-prfaesxcbc-ecp384 esp:aes128-sha256-ecp384"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256gcm96-prfaesxcbc-ecp384
        children {
            child1 {
                mode          = transport
