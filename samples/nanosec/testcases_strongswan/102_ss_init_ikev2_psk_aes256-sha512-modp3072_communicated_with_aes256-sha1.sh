...
TC_NAME="Testcase 102 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256-sha512-modp3072 esp:aes256-sha1-modp3072"
TC_IKE_VERSION=2
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha1 encr_algs aes keylength 32 }
EOF
}
