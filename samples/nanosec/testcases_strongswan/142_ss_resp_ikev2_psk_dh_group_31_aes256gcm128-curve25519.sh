...
# dh group 31 (curve25519), ESP: AES-GCM-256

TC_NAME="Testcase 142 IKEv2 PSK / NanoSec->StrongSwan / dh group 31 (curve25519), ESP: AES-GCM-256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256-sha512-curve25519
        children {
            child1 {
                mode          = transport
