...
# aes256-aesxcbc-modp2048

TC_NAME="Testcase 74 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256-aesxcbc-modp2048 esp:aes128-sha1-modp2048"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256-aesxcbc-modp2048
        children {
            child1 {
                mode          = transport
