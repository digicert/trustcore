...
# dh group 18 (modp8192), ESP: CHACHA-POLY

TC_NAME="Testcase 135 IKEv2 PSK / NanoSec->StrongSwan / dh group 18 (modp8192), ESP: CHACHA-POLY"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256gcm128-prfsha512-modp8192
        children {
            child1 {
                mode          = transport
