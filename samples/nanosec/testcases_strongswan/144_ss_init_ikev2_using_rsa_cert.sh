...
# IKEv2 using RSA Certificate

TC_NAME="Testcase 144 IKEv2 Cert / StrongSwan->NanoSec / RSA Certificate, ike:aes128-sha256-modp3072, esp:aes128-sha256-modp3072"
TC_IKE_VERSION=2
TC_STRONGSWAN_ROLE="init"
TC_SS_CONN_NAME="nanosec-interop"
TC_SS_CHILD_NAME="child1"

if ! tc_gen_certs tc_144 rsa rsa; then
