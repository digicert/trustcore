...
# aes256gcm128-prfsha256-ecp521

TC_NAME="Testcase 96 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256gcm128-prfsha256-ecp521 esp:aes128-sha256-ecp521"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256gcm128-prfsha256-ecp521
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha256-ecp521
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
