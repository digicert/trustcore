...
# ike:aes256-sha512-modp4096 esp:aes128-sha256

TC_NAME="Testcase 151 IKEv1 PSK / PFS Disabled / StrongSwan->NanoSec / ike:aes256-sha512-modp4096 esp:aes128-sha256"
TC_IKE_VERSION=1
TC_STRONGSWAN_ROLE="init"   # StrongSwan is IKE initiator
TC_SS_CONN_NAME="nanosec-interop"
TC_SS_CHILD_NAME="child1"

TC_RESP_IKE_FLAGS=(-p qatestingexample -G 0)
