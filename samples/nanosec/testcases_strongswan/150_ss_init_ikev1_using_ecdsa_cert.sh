# IKEv1 Certificate — StrongSwan initiates, NanoSec responds
# IKEv1 using ECDSA Certificate

TC_NAME="Testcase 150 IKEv1 Cert / StrongSwan->NanoSec / ECDSA Certificate, ike:aes128-sha256-modp3072, esp:aes128-sha256-modp3072"
TC_IKE_VERSION=1
TC_STRONGSWAN_ROLE="init"
TC_SS_CONN_NAME="nanosec-interop"
TC_SS_CHILD_NAME="child1"

if ! tc_gen_certs tc_150 ecdsa ecdsa; then
