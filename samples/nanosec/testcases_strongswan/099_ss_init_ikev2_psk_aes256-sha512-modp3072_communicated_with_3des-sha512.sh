...
TC_NAME="Testcase 99 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256-sha512-modp3072 esp:3des-sha512-modp3072"
TC_IKE_VERSION=2
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha512 encr_algs 3des keylength 24 }
EOF
}
