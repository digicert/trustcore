...
# aes128ccm128-prfsha256-ecp224

TC_NAME="Testcase 85 IKEv2 PSK / StrongSwan->NanoSec / ike:aes128ccm128-prfsha256-ecp224 esp:aes128-sha256-ecp224"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes128ccm128-prfsha256-ecp224
        children {
            child1 {
                mode          = transport
