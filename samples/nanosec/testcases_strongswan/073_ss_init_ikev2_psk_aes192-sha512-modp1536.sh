...
# aes192-sha512-modp1536

TC_NAME="Testcase 73 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192-sha512-modp1536 esp:aes128-sha256-modp1536"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192-sha512-modp1536
        children {
            child1 {
                mode          = transport
