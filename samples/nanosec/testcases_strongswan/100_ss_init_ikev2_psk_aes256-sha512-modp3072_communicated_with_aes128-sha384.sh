...
TC_NAME="Testcase 100 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256-sha512-modp3072 esp:aes128-sha384-modp3072"
TC_IKE_VERSION=2
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha384 encr_algs aes keylength 16 }
EOF
}
