...
# IKEv2 using Ed448 Certificate

TC_NAME="Testcase 147 IKEv2 Cert / StrongSwan->NanoSec / Ed448 Certificate, ike:aes128-sha256-modp3072, esp:aes128-sha256-modp3072"
TC_IKE_VERSION=2
TC_STRONGSWAN_ROLE="init"
TC_SS_CONN_NAME="nanosec-interop"
TC_SS_CHILD_NAME="child1"

if ! tc_gen_certs tc_147 ed448 rsa; then
