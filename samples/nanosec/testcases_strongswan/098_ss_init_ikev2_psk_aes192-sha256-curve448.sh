...
# aes192-sha256-curve448

TC_NAME="Testcase 98 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192-sha256-curve448 esp:aes128-sha256-curve448"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192-sha256-curve448
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha256-curve448
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
