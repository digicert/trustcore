...
# aes256ccm96-prfsha512-ecp192

TC_NAME="Testcase 84 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256ccm96-prfsha512-ecp192 esp:aes128-sha256-ecp192"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256ccm96-prfsha512-ecp192
        children {
            child1 {
                mode          = transport
