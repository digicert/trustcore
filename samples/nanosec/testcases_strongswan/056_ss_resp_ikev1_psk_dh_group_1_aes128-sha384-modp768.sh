...
# dh group 1 (modp768), ESP: AES-CBC-128 & SHA-384

TC_NAME="Testcase 56 IKEv1 PSK / NanoSec->StrongSwan / dh group 1 (modp768), ESP: AES-CBC-128 & SHA-384"
TC_IKE_VERSION=1
...
connections {
    nanosec-interop {
        ...
        proposals = aes128-sha384-modp768
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha384-modp768
                local_ts      = $r/32
                remote_ts     = $i/32
            }
        }
