...
# aes192ccm64-prfsha384-modp2048s256

TC_NAME="Testcase 80 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192ccm64-prfsha384-modp2048s256 esp:aes128-sha256-modp2048s256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192ccm64-prfsha384-modp2048s256
        children {
            child1 {
                mode          = transport
