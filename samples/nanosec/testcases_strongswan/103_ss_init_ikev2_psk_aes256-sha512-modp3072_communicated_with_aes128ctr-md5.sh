...
TC_NAME="Testcase 103 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256-sha512-modp3072 esp:aes128ctr-md5-modp3072"
TC_IKE_VERSION=2
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs md5 encr_algs ctr }
EOF
}
