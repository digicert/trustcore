...
# 3des-sha384-modp1024

TC_NAME="Testcase 72 IKEv2 PSK / StrongSwan->NanoSec / ike:3des-sha384-modp1024 esp:3des-sha384-modp1024"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = 3des-sha384-modp1024
        children {
            child1 {
                mode          = transport
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha384 encr_algs 3des keylength 24 }
EOF
}
