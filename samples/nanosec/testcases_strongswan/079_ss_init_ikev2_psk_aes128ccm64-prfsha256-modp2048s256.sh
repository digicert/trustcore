...
# aes128ccm64-prfsha256-modp2048s256

TC_NAME="Testcase 79 IKEv2 PSK / StrongSwan->NanoSec / ike:aes128ccm64-prfsha256-modp2048s256 esp:aes128-sha256-modp2048s256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes128ccm64-prfsha256-modp2048s256
        children {
            child1 {
                mode          = transport
