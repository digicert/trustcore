...
TC_NAME="Testcase 149 IKEv1 Cert / StrongSwan->NanoSec / RSA Certificate, ike:aes128-sha256-modp3072, esp:aes128-sha256-modp3072"
TC_IKE_VERSION=1
TC_STRONGSWAN_ROLE="init"
TC_SS_CONN_NAME="nanosec-interop"
TC_SS_CHILD_NAME="child1"

if ! tc_gen_certs tc_149 rsa rsa; then
