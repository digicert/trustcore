...
# aes256ccm64-prfsha512-modp2048s256

TC_NAME="Testcase 81 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256ccm64-prfsha512-modp2048s256 esp:aes128-sha256-modp2048s256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256ccm64-prfsha512-modp2048s256
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha256-modp2048s256
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
