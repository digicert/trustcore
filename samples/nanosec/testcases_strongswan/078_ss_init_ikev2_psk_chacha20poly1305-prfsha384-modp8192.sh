...
# chacha20poly1305-prfsha384-modp8192

TC_NAME="Testcase 78 IKEv2 PSK / StrongSwan->NanoSec / ike:chacha20poly1305-prfsha384-modp8192 esp:aes128-sha256-modp8192"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = chacha20poly1305-prfsha384-modp8192
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha256-modp8192
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
