...
# aes256ccm128-prfsha512-ecp224

TC_NAME="Testcase 87 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256ccm128-prfsha512-ecp224 esp:aes128-sha256-ecp224"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256ccm128-prfsha512-ecp224
        children {
            child1 {
                mode          = transport
