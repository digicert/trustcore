...
# aes192ccm128-prfsha384-ecp224

TC_NAME="Testcase 86 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192ccm128-prfsha384-ecp224 esp:aes128-sha256-ecp224"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192ccm128-prfsha384-ecp224
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128-sha256-ecp224
                local_ts      = $i/32
                remote_ts     = $r/32
            }
        }
