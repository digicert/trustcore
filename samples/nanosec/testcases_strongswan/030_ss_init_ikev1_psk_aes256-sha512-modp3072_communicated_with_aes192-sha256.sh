...
TC_NAME="Testcase 30 IKEv1 PSK / StrongSwan->NanoSec / ike:aes256-sha512-modp3072 esp:aes192-sha256-modp3072"
TC_IKE_VERSION=1
...
flush;
spdflush;
{ laddr $r raddr $i } ipsec { encr_auth_algs sha256 encr_algs aes keylength 24 }
EOF
}
