...
# aes192gcm96-prfsha256-ecp384

TC_NAME="Testcase 92 IKEv2 PSK / StrongSwan->NanoSec / ike:aes192gcm96-prfsha256-ecp384 esp:aes128-sha256-ecp384"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes192gcm96-prfsha256-ecp384
        children {
            child1 {
                mode          = transport
