...
# aes128gcm128-prfsha512-ecp521

TC_NAME="Testcase 94 IKEv2 PSK / StrongSwan->NanoSec / ike:aes128gcm128-prfsha512-ecp521 esp:aes128-sha256-ecp521"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes128gcm128-prfsha512-ecp521
        children {
            child1 {
                mode          = transport
