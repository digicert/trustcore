...
# dh group 2 (modp1024), ESP: AES-CTR-128 & SHA-256

TC_NAME="Testcase 57 IKEv1 PSK / NanoSec->StrongSwan / dh group 2 (modp1024), ESP: AES-CTR-128 & SHA-256"
TC_IKE_VERSION=1
...
connections {
    nanosec-interop {
        ...
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128ctr-sha256-modp1024
                local_ts      = $r/32
                remote_ts     = $i/32
            }
        }
