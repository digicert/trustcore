...
# aes256gcm64-prfsha512-ecp256

TC_NAME="Testcase 90 IKEv2 PSK / StrongSwan->NanoSec / ike:aes256gcm64-prfsha512-ecp256 esp:aes128-sha256-ecp256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256gcm64-prfsha512-ecp256
        children {
            child1 {
                mode          = transport
