...
# dh group 26 (ecp224), ESP: AES-CCM-256

TC_NAME="Testcase 141 IKEv2 PSK / NanoSec->StrongSwan / dh group 26 (ecp224), ESP: AES-CCM-256"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256-sha512-ecp224
        children {
            child1 {
                mode          = transport
                esp_proposals = aes256ccm128
                local_ts      = $r/32
                remote_ts     = $i/32
            }
        }
