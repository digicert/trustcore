...
# dh group 24 (modp2048s256), ESP: AES-CCM-128

TC_NAME="Testcase 67 IKEv1 PSK / NanoSec->StrongSwan / dh group 24 (modp2048s256), ESP: AES-CCM-128"
TC_IKE_VERSION=1
...
connections {
    nanosec-interop {
        ...
        proposals = aes128-sha256-modp2048s256
        children {
            child1 {
                mode          = transport
                esp_proposals = aes128ccm64-modp2048s256
                local_ts      = $r/32
                remote_ts     = $i/32
            }
        }
