...
# dh group 5 (modp1536), ESP: AES-CBC-128 & SHA-384

TC_NAME="Testcase 130 IKEv2 PSK / NanoSec->StrongSwan / dh group 5 (modp1536), ESP: AES-CBC-128 & SHA-384"
TC_IKE_VERSION=2
...
connections {
    nanosec-interop {
        ...
        proposals = aes256-sha512-modp1536
        children {
            child1 {
                mode          = transport
