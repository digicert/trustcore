...
#if (defined(__ENABLE_DIGICERT_SRTP_DTLS_EXAMPLE__))
extern void
...
#ifdef __ENABLE_DIGICERT_MCP_EXAMPLE__
...
#elif (defined(__ENABLE_DIGICERT_EAP_PEER__))     /* not authenticator but a peer/supplicant */

#if (defined(__ENABLE_DIGICERT_EAP_FAST__) && defined (__ENABLE_DIGICERT_SSL_ASYNC_CLIENT_API__) \
     && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) )
extern sbyte4 EAP_FAST_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern void EAP_FAST_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_PEAP__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
extern sbyte4 EAP_PEAP_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_PEAP_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_TTLS__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
extern sbyte4 EAP_TTLS_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_TTLS_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_TLS__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
extern sbyte4 EAP_TLS_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_TLS_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_MD5__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__)&& !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
...
#elif (defined(__ENABLE_DIGICERT_EAP_LEAP__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) )
extern sbyte4 EAP_LEAP_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_LEAP_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_MSCHAPv2__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
extern sbyte4 EAP_MSCHAPv2_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_MSCHAPv2_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_PSK__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__)&& !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) )
extern sbyte4 EAP_PSK_PEER_EXAMPLE_getArgs(int argc, char *argv[]);
extern sbyte4 EAP_PSK_PEER_EXAMPLE_main(void*);

#elif (defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) )
...
#ifdef __ENABLE_DIGICERT_WPA2__
...
#if (defined (__ENABLE_DIGICERT_DTLS_CLIENT_EXAMPLE__) || \
     defined (__ENABLE_DIGICERT_DTLS_SERVER_EXAMPLE__))
static intBoolean s_runSSL = FALSE;     /* default will run DTLS */
#endif

#ifdef __PLATFORM_HAS_GETOPT__

#if ((defined(__ENABLE_DIGICERT_EAP_RADIUS__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_RADIUS_SERVER__)) || \
     (defined(__ENABLE_DIGICERT_EAP_PEAP__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__)))
...
#ifdef __ENABLE_DIGICERT_EXAMPLE_DEBUG_CONSOLE__
...
#ifdef __ENABLE_DIGICERT_NANOPNAC__
...
#ifndef __ENABLE_DIGICERT_IKE_SERVER_EXAMPLE__
static MSTATUS
...
#if defined(__ENABLE_DIGICERT_MEM_PART__) && !defined(__ENABLE_DIGICERT_IKE_SERVER__)

#ifdef __ENABLE_DIGICERT_EXTERNAL_STATIC_MEM__
...
#ifndef __ENABLE_DIGICERT_TEST_MAIN__
#if !defined(__DISABLE_DIGICERT_MAIN_FUNC_ENTRY__)
...
#if !defined(__DISABLE_DIGICERT_INIT__) || defined(__ENABLE_DIGICERT_SERVICE_MAIN__)
    MSTATUS status;
#endif
#if defined(__ENABLE_DIGICERT_SERVICE_MAIN__)
...
#ifdef __FREERTOS_RTOS__
#if defined(__ENABLE_DIGICERT_RTOS_IGNORE_TIMEDATE__)
    TimeDate td;
    td.m_year = 51; /*2021*/
...
/* TODO */
    /* Since DIGICERT_initDigicert() creates off threads and waits till its conditions are met, this would not work fine
    ...
    /* sample code for RANDOM apis */
    {
        ...
        DIGI_MEMCPY(key, &timeSeed, sizeof(timeSeed));
    ...
    if (0 > DIGICERT_initLog(exampleLogFn))
        goto exit;
...
#if (defined (__ENABLE_DIGICERT_ESTC__) && !(defined(__ENABLE_DIGICERT_TRUSTPOINT_LOCAL__)))
...
#elif (defined(__ENABLE_DIGICERT_SYSLOG_CLIENT_EXAMPLE__))
...
#elif (defined(__ENABLE_DIGICERT_SRTP_DTLS_EXAMPLE__))
...
#elif (defined(__ENABLE_DIGICERT_HTTP_CLIENT_EXAMPLE__))
...
#elif ((defined(__ENABLE_DIGICERT_SSL_CLIENT_EXAMPLE__)) && (!(defined(__ENABLE_DIGICERT_LDAP_CLIENT_EXAMPLE__) || defined(__ENABLE_DIGICERT_EAP_AUTH__) || defined(__ENABLE_DIGICERT_EAP_PEER__) || defined(__ENABLE_DIGICERT_CFGMON__) || defined(__ENABLE_DIGICERT_EST_CLIENT_EXAMPLE__) || defined(__ENABLE_DIGICERT_ESTC__) || defined(__ENABLE_UMP_CLIENT_CMS_EXAMPLE__) || defined(__ENABLE_DIGICERT_TPUC_SVC__) || defined(__ENABLE_DIGICERT_CLI__))))
...
#elif ((defined(__ENABLE_DIGICERT_SSL_SERVER_EXAMPLE__)) && (!(defined(__ENABLE_DIGICERT_EAP_AUTH__) || defined(__ENABLE_DIGICERT_EAP_PEER__) || defined(__ENABLE_DIGICERT_TRUSTPOINT_LOCAL__) )))
...
#elif (defined(__ENABLE_DIGICERT_SRTP_EXAMPLE__))
...
#if (defined(__ENABLE_DIGICERT_EAP_AUTH__))
#if (defined(__ENABLE_DIGICERT_EAP_FAST__) && defined (__ENABLE_DIGICERT_SSL_ASYNC_SERVER_API__)) && !(defined(__ENABLE_RADIUS_SERVER__))
...
#elif (defined(__ENABLE_DIGICERT_EAP_TLS__) && !defined(__ENABLE_DIGICERT_EAP_PEAP__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__)) && !(defined(__ENABLE_RADIUS_SERVER__))
...
#elif (defined(__ENABLE_DIGICERT_EAP_MD5__) && !(defined(__ENABLE_RADIUS_SERVER__)))
...
#elif (defined(__ENABLE_DIGICERT_EAP_MSCHAPv2__)) && !(defined(__ENABLE_RADIUS_SERVER__))
...
#elif (defined(__ENABLE_DIGICERT_EAP_RADIUS__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_RADIUS_SERVER__) )
...
#if ( defined(__ENABLE_DIGICERT_EAP_FAST__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__))
...
#elif (defined(__ENABLE_DIGICERT_EAP_TLS__) && !defined(__ENABLE_DIGICERT_EAP_PEAP__) && !defined(__ENABLE_DIGICERT_DOT11_SME_EXAMPLE__) && !defined(__ENABLE_DIGICERT_EAP_CLI_EXAMPLES__))
...
#ifdef __ENABLE_DIGICERT_DOT11_SME_EXAMPLE__
#if defined (__ENABLE_DIGICERT_WPA2_WEXT__) || defined(__ENABLE_DIGICERT_WPA2_WIRED__)  /* Add all compilation modes where command line arguments need to be processed*/
...
#endif
#if ((defined (__ENABLE_DIGICERT_SCEP_CLIENT_EXAMPLE__) || defined (__ENAB_DIGICERT_ERT_SCEP_CLIENT_ECDSA_EXAMPLE__)) && (!defined(__EN_DIGICERT_ICERT_SCEPC__)))
#if defined (__ENABLE_DIGICERT_SCEP_CLIENT_OPT__)
    SCEP_CLIENT_EXAMPLE_freeArgs();
#endif
#endif
#if ((defined (__ENABLE_DIGICERT_SCEPC__) || defined (__ENAB_DIGICERT_ERT_SCEP_CLIENT_ECDSA_EXAMPLE__)) && (!defined (__EN_DIGICERT_ICERT_SCEP_CLIENT_EXAMPLE__)))
#if defined (__ENABLE_DIGICERT_SCEP_CLIENT_OPT__)
...
#endif
#ifdef __ENABLE_DIGICERT_SERVICE_MAIN__
    if (OK > status)
        return -1;
    else
        return 0;
...
sbyte4 VxWmainExt(sbyte4 argc, char *argv[], ubyte mainType)
{
    ...
    */
    ...
    switch(mainType)
    {
        ...
        break;
#endif
#if defined(__ENABLE_DIGICERT_SSL_CLIENT_EXAMPLE_VXWORKS__)
        ...
        break;
#endif
#if defined(__ENABLE_DIGICERT_SSL_SERVER_EXAMPLE_VXWORKS__)
        case SSL_MAIN:
        {
...
#ifdef __ENABLE_DIGICERT_NANOPNAC__ /* This should be added for entire FreeRTOS range*/
...
#endif /* __ENABLE_DIGICERT_TEST_MAIN__ */

#endif /* defined(__ENABLE_DIGICERT_EXAMPLES__) */
