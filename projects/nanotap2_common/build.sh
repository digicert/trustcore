...
PROJECT_NAME=libnanotap2_common
######################
function show_usage
{
  echo ""
  echo "./build.sh --gdb --debug --tpm2 --tpm12 --data-protect --tap-remote --toolchain <string> <MAKETARGETS>"
  echo ""
...
do
    case "$1" in
        ...
        --x64)
            ...
            ;;
        --suiteb)
            echo "Suiteb is built by default";
            ;;
        --disable-suiteb)
