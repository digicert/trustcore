...
function(builder_add_flags_to_files FLAGS_VAR FILES_VAR)
    message("----------------")
    file(STRINGS ${FLAGS_VAR} FLAGS_LIST)
    file(STRINGS ${FILES_VAR} FILES_LIST)

    string(REGEX REPLACE "MSS_SRC_DIR/" "${MSS_SRC_DIR}/" FILES_LIST "${FILES_LIST}")
    string(REPLACE ";" " " space_separated_list "${FLAGS_LIST}")
    foreach(FILE ${FILES_LIST})
        set_source_files_properties(${FILE} PROPERTIES COMPILE_FLAGS "${space_separated_list}")
    endforeach()
endfunction()
